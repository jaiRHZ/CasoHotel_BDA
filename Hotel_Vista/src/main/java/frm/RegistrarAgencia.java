...
public class RegistrarAgencia extends javax.swing.JDialog {
     ...
     */
    public RegistrarAgencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarAgencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RegistrarAgencia dialog = new RegistrarAgencia(new javax.swing.JFrame(), true);
